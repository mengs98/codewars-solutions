...
===========
*/
const isPythagoreanTriple = integers => integers.sort((a, b) => a - b).reduce((acc, curr, idx) => idx === 0 || idx === 1 ? acc + curr ** 2 : acc === curr ** 2, 0);
...
const isPythagoreanTriple = integers => {
  ...
  return sortedIntegers[0] ** 2 + sortedIntegers[1] ** 2 === sortedIntegers[2] ** 2;
}
*/